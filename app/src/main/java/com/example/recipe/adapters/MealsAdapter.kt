...
import com.example.recipe.databinding.MealItemBinding
import com.example.recipe.pojo.Meal

class MealsAdapter(private val clickListener: OnItemClickListener) : RecyclerView.Adapter<MealsAdapter.FavoritesMealsAdapterViewHolder>() {
